    ...
    <div className="min-h-screen bg-[#060606] text-white overflow-x-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6 py-12">
        ...
        <nav aria-label="Breadcrumb" className="mb-6">
          <ol className="flex items-center gap-2 text-xs text-white/30 font-mono">
            <li><Link href="/" className="hover:text-white/55 transition-colors">Home</Link></li>
            <li>/</li>
            <li><Link href="/explore" className="hover:text-white/55 transition-colors">Explore</Link></li>
            <li>/</li>
            <li className="text-white/50 truncate max-w-[200px]">{slug}</li>
          </ol>
        </nav>
